...
\               - Ported to ZForth! (random routines)
\                 Marshall Vandegrift, 2009-09-26
...
false value wiping              \ if true: wipe brick, else draw brick
...
131 value left-key          \ customize if you don't like them
129 value rot-key           \ currently this values are for the
132 value right-key         \ arrow key's in Win32Forth
130 value drop-key
...
: show-next-brick    false to wiping draw-next-brick ;
: hide-next-brick    true to wiping draw-next-brick ;
